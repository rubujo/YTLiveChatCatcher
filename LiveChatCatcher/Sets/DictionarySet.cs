...
public class DictionarySet
{
    ...
    private static readonly Dictionary<EnumSet.DisplayLanguage, RegionData> DictRegion = new()
    {
        ...
        { EnumSet.DisplayLanguage.Latvian, new RegionData() { Gl = "LV", Hl = "lv", TimeZone = "Europe/Riga", AcceptLanguage = "lv-LV,lv;q=0.9,en-US;q=0.8,en-GB;q=0.7,en;q=0.6" } },
        { EnumSet.DisplayLanguage.Lithuanian, new RegionData() { Gl = "LT", Hl = "lt", TimeZone = "Europe/Vilnius", AcceptLanguage = "lt-LT,lt;q=0.9,en-US;q=0.8,en-GB;q=0.7,en;q=0.6" } },
        { EnumSet.DisplayLanguage.Macedonian, new RegionData() { Gl = "MK", Hl = "mk", TimeZone = "Europe/Belgrade", AcceptLanguage = "mk-MK,mk;q=0.9,en-US;q=0.8,en-GB;q=0.7,en;q=0.6" } },
        { EnumSet.DisplayLanguage.Malay, new RegionData() { Gl = "MY", Hl = "ms", TimeZone = "Asia/Singapore", AcceptLanguage = "ms-MY,ms;q=0.9,en-US;q=0.8,en-GB;q=0.7,en;q=0.6" } },
        { EnumSet.DisplayLanguage.Malayam, new RegionData() { Gl = "IN", Hl = "ml", TimeZone = "Asia/Kolkata", AcceptLanguage = "ml-IN,ml;q=0.9,en-US;q=0.8,en-GB;q=0.7,en;q=0.6" } },
        { EnumSet.DisplayLanguage.Marathi, new RegionData() { Gl = "IN", Hl = "mr", TimeZone = "Asia/Kolkata", AcceptLanguage = "mr-IN,mr;q=0.9,en-US;q=0.8,en-GB;q=0.7,en;q=0.6" } },
        { EnumSet.DisplayLanguage.Nepali, new RegionData() { Gl = "NP", Hl = "ne", TimeZone = "Asia/Kathmandu", AcceptLanguage = "ne-NP,ne;q=0.9,en-US;q=0.8,en-GB;q=0.7,en;q=0.6" } },
        { EnumSet.DisplayLanguage.Norwegian, new RegionData() { Gl = "NO", Hl = "no", TimeZone = "Europe/Berlin", AcceptLanguage = "no-NO,no;q=0.9,en-US;q=0.8,en-GB;q=0.7,en;q=0.6" } },
        { EnumSet.DisplayLanguage.Persian, new RegionData() { Gl = "IR", Hl = "fa", TimeZone = "Asia/Tehran", AcceptLanguage = "fa-IR,fa;q=0.9,en-US;q=0.8,en-GB;q=0.7,en;q=0.6" } },
        { EnumSet.DisplayLanguage.Polish, new RegionData() { Gl = "PL", Hl = "pl", TimeZone = "Europe/Warsaw", AcceptLanguage = "pl-/pl,pl;q=0.9,en-US;q=0.8,en-GB;q=0.7,en;q=0.6" } },
        ...
        { EnumSet.DisplayLanguage.Punjabi, new RegionData() { Gl = "IN", Hl = "pa", TimeZone = "Asia/Kolkata", AcceptLanguage = "pa-IN,pa;q=0.9,en-US;q=0.8,en-GB;q=0.7,en;q=0.6" } },
        { EnumSet.DisplayLanguage.Romanian, new RegionData() { Gl = "RO", Hl = "ro", TimeZone = "Europe/Bucharest", AcceptLanguage = "ro-RO,ro;q=0.9,en-US;q=0.8,en-GB;q=0.7,en;q=0.6" } },
        { EnumSet.DisplayLanguage.Russian, new RegionData() { Gl = "RU", Hl = "ru", TimeZone = "Europe/Moscow", AcceptLanguage = "ru-RU,ru;q=0.9,en-US;q=0.8,en-GB;q=0.7,en;q=0.6" } },
        { EnumSet.DisplayLanguage.Serbian, new RegionData() { Gl = "RS", Hl = "sr", TimeZone = "Europe/Belgrade", AcceptLanguage = "sr-RS,sr;q=0.9,en-US;q=0.8,en-GB;q=0.7,en;q=0.6" } },
        { EnumSet.DisplayLanguage.Sinhalese, new RegionData() { Gl = "LK", Hl = "si", TimeZone = "Asia/Colombo", AcceptLanguage = "si-LK,si;q=0.9,en-US;q=0.8,en-GB;q=0.7,en;q=0.6" } },
        { EnumSet.DisplayLanguage.Slovak, new RegionData() { Gl = "SK", Hl = "sk", TimeZone = "Europe/Prague", AcceptLanguage = "sk-SK,sk;q=0.9,en-US;q=0.8,en-GB;q=0.7,en;q=0.6" } },
        { EnumSet.DisplayLanguage.Slovenian, new RegionData() { Gl = "SI", Hl = "sl", TimeZone = "Europe/Belgrade", AcceptLanguage = "sl-SI,sl;q=0.9,en-US;q=0.8,en-GB;q=0.7,en;q=0.6" } },
        { EnumSet.DisplayLanguage.Spanish, new RegionData() { Gl = "ES", Hl = "es", TimeZone = "Europe/Madrid", AcceptLanguage = "es-ES,es;q=0.9,en-US;q=0.8,en-GB;q=0.7,en;q=0.6" } },
        { EnumSet.DisplayLanguage.Swahili, new RegionData() { Gl = "KE", Hl = "sw", TimeZone = "Africa/Nairobi", AcceptLanguage = "sw-KE,sw;q=0.9,en-US;q=0.8,en-GB;q=0.7,en;q=0.6" } },
        { EnumSet.DisplayLanguage.Swedish, new RegionData() { Gl = "SE", Hl = "sv", TimeZone = "Europe/Berlin", AcceptLanguage = "sv-SE.sv;q=0.9,en-US;q=0.8,en-GB;q=0.7,en;q=0.6" } },
        { EnumSet.DisplayLanguage.Tagalog, new RegionData() { Gl = "PH", Hl = "tl", TimeZone = "Asia/Manila", AcceptLanguage = "tl-PH,tl;q=0.9,en-US;q=0.8,en-GB;q=0.7,en;q=0.6" } },
        { EnumSet.DisplayLanguage.Tamil, new RegionData() { Gl = "IN", Hl = "ta", TimeZone = "Asia/Kolkata", AcceptLanguage = "ta-IN,ta;q=0.9,en-US;q=0.8,en-GB;q=0.7,en;q=0.6" } },
        { EnumSet.DisplayLanguage.Telugu, new RegionData() { Gl = "IN", Hl = "te", TimeZone = "Asia/Kolkata", AcceptLanguage = "te-IN,te;q=0.9,en-US;q=0.8,en-GB;q=0.7,en;q=0.6" } },
        { EnumSet.DisplayLanguage.Thai, new RegionData() { Gl = "TH", Hl = "th", TimeZone = "Asia/Bangkok", AcceptLanguage = "th-TH,th;q=0.9,en-US;q=0.8,en-GB;q=0.7,en;q=0.6" } },
        { EnumSet.DisplayLanguage.Turkish, new RegionData() { Gl = "TR", Hl = "tr", TimeZone = "Europe/Istanbul", AcceptLanguage = "tr-TR,tr;q=0.9,en-US;q=0.8,en-GB;q=0.7,en;q=0.6" } },
        { EnumSet.DisplayLanguage.Ukrainian, new RegionData() { Gl = "UA", Hl = "uk", TimeZone = "Europe/Kyiv", AcceptLanguage = "uk-UA,uk;q=0.9,en-US;q=0.8,en-GB;q=0.7,en;q=0.6" } },
        { EnumSet.DisplayLanguage.Urdu, new RegionData() { Gl = "PK", Hl = "ur", TimeZone = "Asia/Karachi", AcceptLanguage = "ur-PK,ur;q=0.9,en-US;q=0.8,en-GB;q=0.7,en;q=0.6" } },
        { EnumSet.DisplayLanguage.Uzbek, new RegionData() { Gl = "UZ", Hl = "uz", TimeZone = "Asia/Samarkand", AcceptLanguage = "uz-UZ,uz;q=0.9,en-US;q=0.8,en-GB;q=0.7,en;q=0.6" } },
        { EnumSet.DisplayLanguage.Vietnamese, new RegionData() { Gl = "VN", Hl = "vi", TimeZone = "Asia/Ho_Chi_Minh", AcceptLanguage = "vi-VN,vi;q=0.9,en-US;q=0.8,en-GB;q=0.7,en;q=0.6" } },
        {
